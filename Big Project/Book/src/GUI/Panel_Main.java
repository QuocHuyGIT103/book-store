...
public class Panel_Main extends javax.swing.JFrame {
    ...
    private static TaiKhoan _this_tk;
    /**
...
//        System.out.println("GUI.Panel_Main.<init>() " + _this_tk.getMaNV().getMaNV());
    ...
    public void xuLyDangNhap() {
        if(_this_tk.getLoaiTK().compareTo("LTK001") == 0) {
            lbl_type_NV.setText("Nhân viên bán hàng");
            lbl_name_NV.setText(_this_tk.getTenNguoiDung());
            disableFuntionForNVBH();
        } else {
            lbl_type_NV.setText("Nhân viên quản lý");
            lbl_name_NV.setText(_this_tk.getTenNguoiDung());
        }
    }
...
//        new JDialog_DoiMatKhau(_this_tk, null).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Panel_Main(_this_tk).setVisible(true);
            }
        });
    }
